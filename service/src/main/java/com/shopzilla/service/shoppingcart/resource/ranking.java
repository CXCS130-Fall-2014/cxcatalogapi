...
public class ranking {
    ...
    public void run() {
        try {
            ...
            brandnames = readingExcel("src/brandname.xlsx", "new");
            //brandnames = readingExcel("src/main/java/com.shopzilla.service.shoppingcart/brandname.xlsx", "new");
    ...
    public void cleanup() throws Exception {
        ...
        SQLAccess db_handler = new SQLAccess();
        db_handler.insertPopularTags(populartags);

        if (lifetime < 0 ) {

            lifetime = maxlifetime;
            System.out.println("writing");
            writingExcel("src/brandname.xlsx");
            scores.clear();
            Vector<String> new_brandnames = readingExcel("src/brandname.xlsx", "mutable");
            for (int i = 0; i < brandnames.size(); i++) {
                scores.put(brandnames.elementAt(i), 0);
            }
